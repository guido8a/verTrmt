...
class ElementosTagLib {
     ...
     */
    def favicon = { attrs ->
        def html = "     <link rel=\"shortcut icon\" href=\"${resource(dir: 'images', file: 'gadpp.png')}\">"
        out << html
    }

    def bootstrapCss = { attrs ->
        def html = "<link href=\"${resource(dir: 'stylesheets', file: 'bootstrap.css')}\" rel=\"stylesheet\">"
        out << html
    }

    def bootstrapJs = { attrs ->
        def html = "<script src=\"${resource(dir: 'javascripts', file: 'bootstrap.js')}\"></script>"
        out << html
    }
